...
As 6 pessoas são alocadas, aleatorimamente, a um dos tratamentos:
...
Como temos `r choose(6,3)` combinações possíveis e  `r sum(abs(diff)>=abs(xbarA-xbarB))` com valores iguais ou mais extremos ao valor de diferença observada no experimento, temos que o p-valor é:
...
As 20 pessoas são alocadas, aleatorimamente, a um dos tratamentos.

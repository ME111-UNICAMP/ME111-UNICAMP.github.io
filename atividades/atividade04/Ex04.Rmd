...
```{r,echo=FALSE}
dados <- data.frame(Experimento=XXXXXX,M=XXXXX,n=XXXXXX,m=XXXXXX) # preencha com os dados da tabela feita em aula
dados$Nest <- XXXXXXXX # coloque a formula apropriada
```

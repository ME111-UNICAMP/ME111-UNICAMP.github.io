...
* Após a realização do experimento, observamos o número de copos identificados corretamente como tendo Coca-cola: $x=XX$. 

* Temos a seguinte tabela observada:

  Resposta                      | Copo tem Coca-cola  | Copo tem Coca Zero|   Total    
------------------------| ------------------------- | ------------------------- |---------- 
**Aluno diz coca-cola** | $x=XX$                       |          $6-XX$              | $6$ 
**Aluno diz coca zero** |                     |                        | 
            **Total**              | $6$                   | $6$                     | $12$      
...
* Caso o aluno tivesse acertado todos os copos, teríamos ainda mais evidência contra $H_0$? Devemos então incluir a probabilidade de um resultado ainda "mais extremo" contra $H_0$.
...
* Se o número de copos preparados no experimento fosse 10 (5 de cada tipo) e o aluno acertasse todos os 5, você teria evidências suficientes para rejeitar $H_0$? Justifique com cálculos de probabilidades. 

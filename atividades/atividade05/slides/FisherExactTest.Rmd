...
* Para decidir, precisamos da distribuição de probabilidade da estatística do teste quando $H_0$ é verdadeira.
...
## Teste Exato de Fisher
  ...
  Variável 1/Variável 2                      |  $2A$  |  $2B$|   Total    
------------------------| ------------------------- | ------------------------- |---------- 
**$1A$** | $x$                       |            $n-x$            | $n$ 
**$1B$** |                     |                       | $N-n$ 
            **Total**              | $r$                   | $N-r$                     | $N$      
...
* $H_0$: variáveis 1 e 2 independentes

* Sob $H_0$, qual a probabilidade de se obter a tabela observada no experimento realizado? (Margens fixas: Hipergeométrica).

* Sob $H_0$, qual a probabilidade de se obter tabelas "mais extremas" (mais distantes de $H_0$, na "direção" de $H_a$), quando fixamos as marginais da tabela observada?
...
$\hat{p}_1 = \frac{a}{n_1}$ é a proporção amostral de sucessos no tratamento 1.

$\hat{p}_2 = \frac{a}{n_2}$ é a proporção amostral de sucessos no tratamento 2.
...
O valor de $p$ é calculado como $P(X\leq x)=P\left(X\leq \frac{1}{6}-\frac{4}{8}\right)=P(X=x_1)+P(X=x_2)=\frac{`r choose(6,1)* choose(8,4)`}{`r choose(14,5)`}+\frac{`r choose(6,0)* choose(8,5)`}{`r choose(14,5)`}$
...
$$
\begin{eqnarray}
P(X\geq x)&=&P\left(X\geq \frac{1}{6}-\frac{4}{8}\right)=P(X=x_1)+P(X=x_3)+P(X=x_4)\\
